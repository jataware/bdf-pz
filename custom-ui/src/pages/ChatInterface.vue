            ...
            <div class="beaker-dev-interface">
                ...
                <header style="justify-content: center;">                
                    <VerticalToolbar style="align-self: flex-start;">
                        <template #start>
                            <img :src="palimpzestLogo" alt="Palimpzest Logo" class="header-logo" style="margin-bottom: 10px;">
                            <Button
                                outlined
                                size="small"
                        ...
                        >
                            <template #help-text>
                                <div style="text-align: center; margin-bottom: 2rem;">
                                    <p>Hi! I'm your Palimpzest Agent and I can help you do all sorts of information extraction tasks. How can I assist you?</p>
                                </div>
                            </template>
